...
1. **Do not regenerate** existing packages (`organization-dna`, health, founder, graph, decision, predictive, board-governance, infrastructure, oios, human-capital, revenue, funding, opportunity, organizational-improvement, business-model).
...
Operations, Customer, Knowledge, Document, Legal, Compliance, Risk, Market, Innovation, Impact, Economic Intelligence.
...
- After Revenue (033), Funding (034), Opportunity (035), Organizational Improvement (036), and Business Model (037), prefer soft context attachments over hard DAG edges unless required for pipeline data
