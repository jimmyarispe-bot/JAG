...
1. **Do not regenerate** existing packages (`organization-dna`, health, founder, graph, decision, predictive, board-governance, infrastructure, oios, human-capital, revenue, funding, opportunity, organizational-improvement, business-model, operations, customer, knowledge).
...
Document, Legal, Compliance, Risk, Market, Innovation, Impact, Economic Intelligence.
...
- After Revenue (033), Funding (034), Opportunity (035), Organizational Improvement (036), Business Model (037), Operations (038), Customer (039), and Knowledge (040), prefer soft context attachments over hard DAG edges unless required for pipeline data
