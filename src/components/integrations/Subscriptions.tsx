...
import type { SubscriptionsWidget } from "@/lib/platform/integrations/connectors/finance/intelligence/ecc-widgets";
    ...
    <section className={cn("rounded-xl border border-slate-200 bg-white p-4", className)}>
      ...
      <dl className="mt-3 grid grid-cols-2 gap-2 text-center text-xs text-slate-600">
        ...
        <div>
          ...
          <dd className="text-lg font-semibold text-slate-900">{widget.activeCount}</dd>
        </div>
      </dl>
    </section>
  );
