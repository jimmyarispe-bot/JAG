...
export function resetCommunicationsProofPortsForTests(): void {
  permissionPacks.clear();
}

export function listCommunicationsProofPermissionPacks(): PermissionModel[] {
  return [...permissionPacks.values()].sort((a, b) => a.id.localeCompare(b.id));
}

export function createCommunicationsModelCompilerPorts(): ApplicationModelCompilerPorts {
  return {
