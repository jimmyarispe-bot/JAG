...
export function resetDecisionProofPortsForTests(): void {
  permissionPacks.clear();
}

export function listDecisionProofPermissionPacks(): PermissionModel[] {
  return [...permissionPacks.values()].sort((a, b) => a.id.localeCompare(b.id));
}

export function createDecisionModelCompilerPorts(): ApplicationModelCompilerPorts {
  return {
