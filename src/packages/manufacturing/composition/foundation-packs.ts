/**
 * Organization-layer resolution of Manufacturing foundation modules → Capability Packs.
 *
 * Industry Blueprints must not own package ids (constitution).
 * The Advanced Manufacturing Organization Blueprint owns pack attachment.
 * Reuses production packs unchanged — no manufacturing-specific pack forks.
 */

import type { CapabilityPack } from "@/jag/blueprints";
import { MANUFACTURING_FOUNDATION_MODULES } from "@/jag/blueprints";
...
export const MANUFACTURING_FOUNDATION_PACK_IDS = Object.freeze([
  "identity.core",
  "documents.core",
  "communications.core",
  "scheduling.core",
...
/**
 * Build production foundation packs for Manufacturing composition.
 * Order is stable for deterministic Runtime Generation.
 */
export function buildManufacturingFoundationCapabilityPacks(): readonly CapabilityPack[] {
...
export function manufacturingFoundationModules(): readonly string[] {
  return MANUFACTURING_FOUNDATION_MODULES;
}
