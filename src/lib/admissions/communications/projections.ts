...
export const LEAD_MERGE_CONTEXT_COLS =
  "id, school_id, assigned_to_user_id, first_name, last_name, preferred_name, guardian_first_name, guardian_last_name, guardian_email, guardian_phone, program, application_access_token, schools(name, admissions_contact_name, admissions_contact_email, admissions_booking_url, admissions_from_email, shadow_days_url)" as const;
