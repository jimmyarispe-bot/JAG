...
export function statusFromScore(score: number): KnowledgeHealthStatus {
...
export function priorityFromScore(score: number): KnowledgePriorityBand {
...
export function priorityFromRisk(risk: number): KnowledgePriorityBand {
...
export function levelFromValue(value: number): KnowledgeConfidenceLevel {
...
export function emptyKnowledgeScope(): GraphScope {
