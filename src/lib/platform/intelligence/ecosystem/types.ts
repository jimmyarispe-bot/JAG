/**
 * Ecosystem Intelligence — shared types / DTOs.
 *
...
export const ECOSYSTEM_CAPABILITIES = [
  "ecosystem_mapping", "strategic_partnerships", "supplier_ecosystems", "customer_ecosystems", "community_networks", "industry_networks", "technology_ecosystems", "academic_research_partnerships", "government_ecosystems", "investor_funding_networks", "nonprofit_ngo_relationships", "platform_ecosystems", "alliance_intelligence", "network_effects", "ecosystem_dependencies", "collaboration_opportunities", "ecosystem_risk", "ecosystem_analysis", "network_mapping", "partnership_analysis", "dependency_analysis", "collaboration_analysis", "network_effect_analysis", "ecosystem_trends", "ecosystem_forecasts", "scenario_planning", "early_warning", "recommendation_generation", "knowledge_contribution", "closed_learning_loop",
] as const;
...
export interface EcosystemResult {
  ...
  ecosystemMappingScore: EcosystemScore;
  strategicPartnershipsScore: EcosystemScore;
  supplierEcosystemsScore: EcosystemScore;
  customerEcosystemsScore: EcosystemScore;
  communityNetworksScore: EcosystemScore;
  industryNetworksScore: EcosystemScore;
  technologyEcosystemsScore: EcosystemScore;
  academicResearchPartnershipsScore: EcosystemScore;
  governmentEcosystemsScore: EcosystemScore;
  investorFundingNetworksScore: EcosystemScore;
  nonprofitNgoRelationshipsScore: EcosystemScore;
  platformEcosystemsScore: EcosystemScore;
  allianceIntelligenceScore: EcosystemScore;
  networkEffectsScore: EcosystemScore;
  ecosystemDependenciesScore: EcosystemScore;
  collaborationOpportunitiesScore: EcosystemScore;
  ecosystemRiskScore: EcosystemScore;
