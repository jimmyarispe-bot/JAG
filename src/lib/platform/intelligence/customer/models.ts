...
export function statusFromScore(score: number): CustomerHealthStatus {
...
export function priorityFromScore(score: number): CustomerPriorityBand {
...
export function priorityFromRisk(risk: number): CustomerPriorityBand {
...
export function levelFromValue(value: number): CustomerConfidenceLevel {
...
export function emptyCustomerScope(): GraphScope {
