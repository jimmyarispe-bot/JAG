import type { InstitutionalMemoryReasonerContract } from "@/lib/platform/intelligence/institutional-memory/contracts";
import type { InstitutionalMemoryReasoningResult } from "@/lib/platform/intelligence/institutional-memory/types";
