...
export function emptyHumanCapitalScope(): GraphScope {
...
export function statusFromScore(score: number): WorkforceHealthStatus {
...
export function priorityFromScore(score: number): HumanCapitalPriorityBand {
...
export function priorityFromRisk(score: number): HumanCapitalPriorityBand {
...
export function levelFromValue(value: number): HumanCapitalConfidenceLevel {
