...
export function statusFromScore(score: number): OperationsHealthStatus { return sharedStatusFromScore(score); }

export function priorityFromScore(score: number): OperationsPriorityBand { return priorityFromScoreLowUrgent(score); }

export function priorityFromRisk(risk: number): OperationsPriorityBand { return sharedPriorityFromRisk(risk); }

export function levelFromValue(value: number): OperationsConfidenceLevel { return sharedLevelFromValue(value); }
...
export function buildConfidence(
  ...
  return buildConfidenceAverageEmptyHalf(factors) as OperationsConfidenceScore;
}
...
export const emptyOperationsScope = (): GraphScope => emptyGraphScope();
