...
export function statusFromScore(score: number): MarketHealthStatus { return sharedStatusFromScore(score); }

export function priorityFromScore(score: number): MarketPriorityBand { return priorityFromScoreLowUrgent(score); }

export function priorityFromRisk(risk: number): MarketPriorityBand { return sharedPriorityFromRisk(risk); }

export function levelFromValue(value: number): MarketConfidenceLevel { return sharedLevelFromValue(value); }
...
export function buildConfidence(
  ...
  return buildConfidenceAverageEmptyHalf(factors) as MarketConfidenceScore;
}
...
export const emptyMarketScope = (): GraphScope => emptyGraphScope();
