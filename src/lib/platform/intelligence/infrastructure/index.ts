...
export {
  ...
  createBusinessModelModule,
  createOperationsModule,
  createCustomerModule,
  createImpactModule,
  createEconomicModule,
  createCompetitiveModule,
  createPoliticalModule,
  createEnvironmentalModule,
  createStakeholderModule,
  createReputationModule,
  createBehavioralModule,
  createCulturalModule,
  createEthicalModule,
  createSystemsModule,
  createResilienceModule,
  createEcosystemModule,
  createInstitutionalMemoryModule,
  createCollectiveModule,
  createWisdomModule,
  createSynthesisModule,
  createBriefingModule,
  createExecutiveMemoryModule,
