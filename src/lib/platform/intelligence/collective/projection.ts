import { buildConfidence, outlookFromScore } from "@/lib/platform/intelligence/collective/models";
import type { CollectiveProjectionResult, CollectiveQueryRequest, CollectiveQueryResult, CollectiveResult } from "@/lib/platform/intelligence/collective/types";
