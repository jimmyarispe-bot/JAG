...
} from "@/lib/platform/integrations/connectors/enterprise/services/demo-catalog";

export type EnterpriseListPage = {
  records: EnterpriseRawEntity[];
...
export interface EnterpriseClient {
  ...
  list(
    ...
    since?: string | null,
    cursor?: string | null
  ): Promise<EnterpriseListPage>;
  objectTypes(): EnterpriseObjectType[];
}

export function createDemoEnterpriseClient(
