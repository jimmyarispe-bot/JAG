...
export function createEducationDomainBuilder(): DomainBuilder {
  ...
  return createDomainBuilder({
    ...
    .registerCognitiveContributor(contributors.studentSuccessCognition)
    .registerCognitiveContributor(contributors.interventionCognition)
    .registerCognitiveContributor(contributors.familyEngagementCognition)
    .registerCognitiveContributor(contributors.supportPlanningCognition)
    .registerCognitiveContributor(contributors.schedulingCognition)
    .registerCognitiveContributor(contributors.staffingCognition)
    .registerCognitiveContributor(contributors.capacityCognition)
    .registerCognitiveContributor(contributors.operationalReadinessCognition)
    .registerCognitiveContributor(contributors.scholarshipCognition)
    .registerCognitiveContributor(contributors.complianceCognition)
    .registerCognitiveContributor(contributors.fundingReadinessCognition)
    .registerCognitiveContributor(contributors.schoolHealthCognition)
    .registerCognitiveContributor(contributors.campusPerformanceCognition)
    .registerCognitiveContributor(contributors.executiveBriefingCognition)
