...
import { CALENDAR_OBJECT_TYPES } from "@/lib/platform/integrations/microsoft-365/calendar";
import { ONEDRIVE_OBJECT_TYPES } from "@/lib/platform/integrations/microsoft-365/onedrive";
import { OUTLOOK_OBJECT_TYPES } from "@/lib/platform/integrations/microsoft-365/outlook";
import { SHAREPOINT_OBJECT_TYPES } from "@/lib/platform/integrations/microsoft-365/sharepoint";
import { TEAMS_OBJECT_TYPES } from "@/lib/platform/integrations/microsoft-365/teams";
import { runMicrosoft365Sync } from "@/lib/platform/integrations/microsoft-365/sync";
...
export async function POST(request: NextRequest) {
  ...
  let body: {
    ...
    forceFull?: boolean;
    module?: "outlook" | "calendar" | "onedrive" | "sharepoint" | "teams" | "all";
    objectTypes?: string[];
  } = {};
  try {
  ...
  const objectTypes = body.objectTypes?.length
    ...
    : body.module === "outlook"
      ...
      : body.module === "calendar"
        ...
        : body.module === "onedrive"
          ? [...ONEDRIVE_OBJECT_TYPES]
          : body.module === "sharepoint"
