/**
 * Mr. JAG API helpers — Platform session gates; no Foundation contract changes.
 */
...
export async function requireMrJagOrg(request: Request) {
...
export async function requireMrJagOrgBody(body: {
