/**
 * Evolution API helpers — Platform session gates; proposal-only surface.
 */
...
export async function requireEvolutionOrg(request: Request) {
...
export async function requireEvolutionOrgBody(body: {
