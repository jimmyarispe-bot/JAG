/**
 * Thin AcademyOS API helpers — consume Platform session gates; do not modify Foundation.
 */
...
export async function requireAcademyOsOrg(request: Request) {
...
export async function requireAcademyOsOrgBody(body: {
