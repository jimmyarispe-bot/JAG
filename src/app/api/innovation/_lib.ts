/**
 * Innovation API helpers — Platform session gates.
 */
...
export async function requireInnovationOrg(request: Request) {
...
export async function requireInnovationOrgBody(body: {
