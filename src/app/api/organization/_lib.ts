/**
 * Universal Organization API helpers — Platform session gates.
 */
...
export async function requireOrgModelOrg(request: Request) {
...
export async function requireOrgModelOrgBody(body: {
