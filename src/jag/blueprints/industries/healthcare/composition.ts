/**
 * Healthcare foundation composition — module graph only.
 *
...
} from "@/jag/blueprints/industries/healthcare/catalogs";

export type HealthcareFoundationModule =
  (typeof HEALTHCARE_FOUNDATION_MODULES)[number];

export type HealthcareVerticalModule =
  (typeof HEALTHCARE_VERTICAL_MODULES)[number];

/** Ordered foundation module composition for Healthcare v1. */
export const HEALTHCARE_BLUEPRINT_COMPOSITION = Object.freeze({
  version: "1.0.0",
