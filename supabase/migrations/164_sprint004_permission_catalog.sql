...
-- Strongly typed coarse access permissions
-- =========================================
...
-- Keep legacy keys as aliases in the DB for existing role grants / RPC checks
insert into public.platform_permissions (permission_key, name, description, module, category, sort_order)
values
  (
    'SYSTEM_CONFIGURATION_ACCESS',
    'System Configuration Access (legacy)',
    'Deprecated alias of SYSTEM_ADMIN_ACCESS.',
    'iam',
    'access',
    141
  ),
  (
    'AUDIT_LOG_ACCESS',
    'Audit Log Access (legacy)',
    'Deprecated alias of AUDIT_ACCESS.',
    'iam',
    'access',
    151
  )
