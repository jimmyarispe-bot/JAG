...
/**
 * Version 18 of the inquiry form — the GA GOAL ask.
 *
...
const sql = readFileSync(
  join(
    ...
    "..",
    "..",
    "supabase/migrations/352_interest_form_v18_ga_goal_fund_2026_09_14.sql"
  ),
  "utf8"
);
...
describe("the GA GOAL fund block", () => {
  ...
  it("drops the old tax-mechanics wording entirely", () => {
    ...
    expect(questions.ga_goal_taxpayer_pledge.label).toBe("Signature");
  });
