...
describe("Funding Intelligence (Sprint 034)", () => {
  ...
  it("runs after revenue before opportunity and organizational-improvement", async () => {
    ...
    expect(result.moduleOrder).toEqual(["organization-dna", "oios-core", "organization-health", "financial", "founder", "executive", "executive-graph", "executive-decision", "predictive", "board-governance", "human-capital", "revenue", "funding", "opportunity", "organizational-improvement", "business-model"]);
